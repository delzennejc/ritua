...
export function workspaceDefaults(): Fields {
  return structuredClone({ areas: DEFAULT_AREAS, tasks: DEFAULT_TASKS, datedTasksByDate: DEFAULT_DATED_TASKS,
    weeklyObjectives: DEFAULT_PROJECTS, archivedObjectives: [], archivedAreas: [], weeklyObjectiveOrder: [],
    events: DEFAULT_EVENTS, 'weekly.accomplishedObjectives': [], backlogGroups: DEFAULT_BACKLOG_GROUPS })
}
