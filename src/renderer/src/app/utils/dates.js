import { localDateKey, addDays, mondayOf, calendarDaysAround, previousWeekDays } from "../../../../domain/calendar-dates";
export { addDays, mondayOf, calendarDaysAround, previousWeekDays };
export let CURRENT_DATE_KEY = localDateKey();
export const refreshDateClock = () => { CURRENT_DATE_KEY = localDateKey(); };
...
export const backlogDateLabel = (
  dateKey,
  currentDateKey = CURRENT_DATE_KEY,
) => {
