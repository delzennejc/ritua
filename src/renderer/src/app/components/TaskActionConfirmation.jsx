...
export function TaskActionPopover({
  ...
  useLayoutEffect(() => {
    const placePopover = () => {
      ...
      const left = Math.max(8, Math.min(anchorCenter - popover.width / 2, window.innerWidth - popover.width - 8));
...
export function TaskActionConfirmation({ id, triggerRef, title, description, confirmLabel, onClose, onConfirm }) {
