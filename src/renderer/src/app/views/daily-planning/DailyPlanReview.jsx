...
export function DailyPlanReview({ tasks, allTasks = tasks, areaFilterProps, planText, setPlanText, onToggle, onToggleSubtask, onAssignObjective, onOpenTask, onBack, onDone, projects }) {
        ...
        <div className="share-layout">
          <div className="weekly-document-primary">
            ...
            <div className="share-actions">
              ...
              <button className="next-button get-started" onClick={onDone}><RocketLaunch size={16} /> Get started</button>
            </div>
          </div>
          <SortableTaskLane
            as="div"
            ...
            allTasks={allTasks}
          >
            {({ taskBoardProps }) => planTasks.map((task, visibleIndex) => (
              <TaskCard
                task={task}
                projects={projects}
                key={task.id}
