  ...
  return (
    <div className={`planning-intro step-${step}`}>
        ...
        >
          <div className="shutdown-card-heading">
            ...
            {shutdownScheduled ? (
              <button
                type="button"
                className="shutdown-remove"
                aria-label="Remove shutdown time"
                title="Remove shutdown time"
                onClick={onRemoveShutdown}
              >
                <X size={14} />
              </button>
            ) : null}
          ...
          <div>
            <input
              ...
              required
            />
            <button type="submit" className="calendar-add">
              <CalendarCheck size={15} /> {shutdownScheduled ? 'Update calendar' : 'Add to calendar'}
            </button>
          </div>
        </form>
      ) : null}
      <div className="wizard-actions">
        ...
        <button className="next-button" onClick={step === 2 ? onFinish : onNext}>
