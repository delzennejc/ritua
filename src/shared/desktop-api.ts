...
import type { WorkspaceCommit } from '../domain/workspace'
...
export const channels = {
  copyTaskImage: 'ritua:copy-task-image',
  importTaskImage: 'ritua:import-task-image',
  readTaskImage: 'ritua:read-task-image',
  updateStatus: 'ritua:update-status',
  checkUpdates: 'ritua:check-updates',
  ...
  loadWorkspace: 'ritua:load-workspace',
  commitWorkspace: 'ritua:commit-workspace',
  flushRequest: 'ritua:flush-request',
  flushReady: 'ritua:flush-ready',
  saveWorkspace: 'ritua:save-workspace',
  writeRecovery: 'ritua:write-recovery',
  readRecovery: 'ritua:read-recovery',
  chooseAttachment: 'ritua:choose-attachment',
  exportAttachment: 'ritua:export-attachment',
  createBackup: 'ritua:create-backup',
  listBackups: 'ritua:list-backups',
  exportBackup: 'ritua:export-backup',
  restoreBackup: 'ritua:restore-backup',
} as const
